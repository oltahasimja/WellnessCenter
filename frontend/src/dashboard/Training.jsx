          ...
          <table className="w-full border-collapse shadow-md rounded-md bg-white">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                <th className="py-3 px-6 text-left">title</th><th className="py-3 px-6 text-left">category</th><th className="py-3 px-6 text-left">description</th><th className="py-3 px-6 text-left">duration</th><th className="py-3 px-6 text-left">max_participants</th>
              ...
              {trainingList.length > 0 ? (
                trainingList.map((item) => (
                  <tr key={item.mysqlId || item.id} className="border-b border-gray-200 hover:bg-gray-100">
                    <td className="py-3 px-6 text-left">{item.title}</td><td className="py-3 px-6 text-left">{item.category}</td><td className="py-3 px-6 text-left">{item.description}</td><td className="py-3 px-6 text-left">{item.duration}</td><td className="py-3 px-6 text-left">{item.max_participants}</td>
